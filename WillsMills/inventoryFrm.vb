...
Public Class inventoryFrm
    ...
    Private Sub insert()
        Try
            dbaccessconnection()
            con.Open()
            cmd.CommandText = "insert into inventory_tb(Product_Code,WholeSeller_Name,Product_Name,Original_Price,Reseller_Rate,Coupon_Price,Sell_Price,WillsMills_Price,Product_Description,Product_Image,Profit_Price,Product_Date)values('" & prodctCode_txt.Text & "','" & wholeSeller_txt.Text & "','" & prodctName_txt.Text & "','" & originalPrice_txt.Text & "','" & resellerRate_txt.Text & "','" & couponPrice_txt.Text & "','" & sellRate_txt.Text & "','" & willMillsPrice_txt.Text & "','" & description_txt.Text & "',@photo,'" & profitPrice_Txt.Text & "','" & entry_date.Value & "' )"
    ...
    Private Sub product_FillCombo()
        Try
            ...
            ds = New DataSet
            tables = ds.Tables
            da = New SqlDataAdapter("SELECT DISTINCT WholeSeller_Name from inventory_tb", myConnToAccess)
